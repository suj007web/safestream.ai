  ...
  return (
    <div className="relative z-20 mx-auto flex max-w-6xl flex-col items-center justify-center px-4 py-24 md:px-8 md:py-36">
      <motion.div
        ...
        className="relative"
      >
        <GlowingChip>Free to use!!🎉</GlowingChip>
      </motion.div>
      <motion.h1
        initial={{
          y: 25,
      ...
      >
        Ensure a safer and cleaner video streaming experience for your children 
        with our advanced content filtering and monitoring solutions.
      </motion.p>
      <motion.div
        initial={{
          y: 25,
